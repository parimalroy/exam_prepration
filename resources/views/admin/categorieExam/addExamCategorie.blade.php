...
<div class="row">
    <div class="col-sm-12">
        <div class="well">
            ...
            {!! Form::open(['url' => 'examCategorie-save','method'=> 'POST','class'=> 'form-horizontal']) !!}
            
            <div class="form-group">
                <label class="control-label col-sm-3">Category Name</label>

                <div class="col-sm-9">
                    <input type='text' name="exam_category_name" class="form-control"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control"rows="4"name="exam_category_description"></textarea>
                    <span class="text-danger"> {{$errors->has('category_name')? $errors->first('category_name'): ''}}</span>
                </div>
