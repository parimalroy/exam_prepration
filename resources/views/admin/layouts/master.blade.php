        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i>{{Session::get('admin_name')}} <i class="fa fa-caret-down"></i>
                        </a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{url('admin-deshboard')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Categories<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{url('categorie_add')}}">Add Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('categorie-manage')}}">Manage Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('sub_categorie_add')}}">Add Sub Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('sub_categorie_manage')}}">Manage Sub Categories</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            <li>
                             ...
                             <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Exam Categories<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{url('examCategorie-addExamCategorie')}}">Add Exam Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('examCategorie-manageExamCategorie')}}">Manage Exam Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('examSubCategorie-addExamSubCategorie')}}">Add Exam Sub Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{url('examSubCategorie-manageExamSubCategorie')}}">Manage Exan Sub Categories</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">@yield('head')</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
